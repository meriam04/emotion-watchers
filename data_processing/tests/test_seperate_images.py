...
# @pytest.mark.parametrize("setup_folders, positive_folder, negative_folder, keyword,",
#                         [([test_files_dir, test_files_dir, test_files_dir, "happy"])])
# def test_separate_images_binary(setup_folders, positive_folder, negative_folder, keyword):
