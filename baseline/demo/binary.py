...
DEMO_DATA_DIR = Path(__file__).parent.parent.parent / "data/demo/binary"
DEMO_WEIGHTS_DIR = Path(__file__).parent.parent / "Binary_CKM.weights"
...
if __name__ == "__main__":
    ...
    dataset.classes = ["negative", "positive"]
